...
授業スライド・サンプルプログラム・入力データを公開しています。

**2026年度の課題は改訂中のため未公開です。提出方法は従来どおりとします。**

## 学生の方へ

1. 課題の公開については授業での案内をお待ちください。
...
`release.json` の `assignments_public` は `false` です。課題PDFをこのリポジトリに置かないでください。公開再開は教員の明示的な指示後に行います。課題を含む旧版の教材一式ZIPも配付対象から外します。
