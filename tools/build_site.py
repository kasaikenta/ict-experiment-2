...
all_files = files('lectures') + files('assignments') + files('materials') + [B / 'course-guide.txt']
bundle = archive('ict-experiment-2', all_files)

def shell(title, main):
    return f'''<!doctype html>
<html lang="ja"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<meta name="description" content="情報通信実験第2の情報理論・符号理論の授業スライド、課題、配付プログラム。">
...
<section class="updates-note"><div><p class="eyebrow">03 / UPDATES</p><h2>更新しても、入口は同じ。</h2><p>このページには現在の配付版を掲載します。公開中の旧版はGitHub Releasesから取得できます。公開を終了した版は除外します。授業で版が指定された場合は、その版を使ってください。</p></div><a class="button secondary" href="updates.html">更新履歴と過去の版 →</a></section>'''
